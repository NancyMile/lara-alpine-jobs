...
Route::get('jobs/tag/{tag}',[JobTagController::class,'index'])->name('jobs.tags.index');

Route::get('login', fn() => to_route('auth.create'))->name('login');//alias
Route::resource('auth',AuthController::class)->only(['create','store']);

Route::delete('logout',fn() => to_route('auth.destroy'))->name('logout'); //alias
