<div class="relative">
    @if($formId)
        <button  type="button" onclick="document.getElementById('{{ $name }}').value =''; document.getElementById('{{ $formId }}').submit(); " class="absolute top-0 right-0 flex h-full items-center pr-2 text-slate-500">
